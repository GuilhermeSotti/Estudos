...
from src.back_end.constants.culturas import Planta, Animal
from src.back_end.utils.log import log_execution
import json

blueprint = Blueprint('plantio', __name__, template_folder=app.config["TEMPLATES_FOLDER"], static_folder=app.config["STATIC_FOLDER"])

@log_execution("Calculando métricas do plantio")
@blueprint.route("/metricas/<string:nome>", methods=["GET"])
